<x-backend>
    <div class="max-w">
        ...
        <div class="card p-7">
            <h2 class="text-lg font-bold text-slate-800 mb-6">Edit Tentang Kami</h2>

            <form action="{{ url('backend/tentang_kami/update', $tentang_kami->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="visi" value="{{ old('visi', $tentang_kami->visi) }}"
                            class="form-input" required>
                    </div>

                    <div>
                        <label class="form-label">Misi <span class="text-red-500">*</span></label>
                        <input type="text" name="misi" value="{{ old('misi', $tentang_kami->misi) }}"
                            class="form-input" required>
                    </div>
                    ...
                    <div class="flex gap-3 pt-2">
                        <a href="{{ url('backend/tentang_kami/index') }}"
