<x-backend>
    <div class="max-w">
        ...
        <div class="card p-7">
            <h2 class="text-lg font-bold text-slate-800 mb-6">Tambah Fasilitas Utama</h2>
            <form action="{{ url('backend/fasilitas-utama') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="space-y-5">
                    <div>
