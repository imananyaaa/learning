<x-backend>
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div>
            <h2 class="text-xl font-bold text-slate-800"> Data Booking yang Dibatalkan</h2>
        </div>
    </div>
                    ...
                    @foreach ($list_booking as $booking)
                        <tr class="tbl-row">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm align-middle">
                                <div class="flex items-center">
                                    ...
                                    @if ($booking->status == '1')
                                        ...
                                        <form action="{{ url('backend/booking/dibatalkan', $booking->id) }}" method="POST"
                                            class="flex">
                                            @csrf
                                            @method('PUT')
                                            <button
                            ...
                            <td class="text-center">
                                ...
                                @elseif ($booking->status == '5')
                                    <span class="btn-primary">Dibatalkan</span>
                                @endif
                            </td>
